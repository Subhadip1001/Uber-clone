    ...
    <div>
      <div className="mt-2 flex justify-between items-center bg-yellow-400 rounded-lg p-2">
        ...
        <div className="flex flex-col items-center ">
          <h3 className="text-xl font-bold">+₹<span>110</span></h3>
        </div>
      </div>
      <div className="w-full mt-5">
          ...
          <div className="flex items-center gap-5 p-3">
            ...
            <Link to="/captain-home" className='bg-green-500 py-2 flex justify-center rounded-lg text-lg font-bold'>Finish</Link>
        </div>
    </div>
  )
}
